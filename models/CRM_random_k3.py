...
if __name__ == "__main__":
    ...
    for i in range(1, num_iterations+1):
        print(f"iteration {i}")
        args_list = [
            (data, new_selected_variables, min_l_supp, 3, 'Z'),
            (data, new_selected_variables, min_l_supp, 3, 'notZ')
        ]
    ...
    try:
        with open(f"seconds_runtime_random_{experiment_name}_{encoding}_k3.txt", "w") as f:
