...
if __name__ == "__main__":
    ...
    for i in range(1, num_iterations+1):
        print(f"iteration {i}")
        args_list = [
            (data, new_selected_variables, min_l_supp, 1, 'Z'),
            (data, new_selected_variables, min_l_supp, 1, 'notZ')
        ]
    ...
    try:
        with open(f"seconds_runtime_random_{experiment_name}_{encoding}_k1.txt", "w") as f:
