...
# Load configuration
with open(os.path.join(PACKAGE_ROOT, "config", "config_feature_extraction_IMPresseD_BPI15A.yaml"), "r", encoding="utf-8") as f:
...
sys.argv = [
    ...
    "question", "dateFinished", "action_code", "activityNameEN",
    "activityNameNL", "lifecycle:transition", "case:caseStatus",
    "case:last_phase", "case:case_type", "case:Responsible_actor",
    "case:parts", "case:termName", "case:requestComplete",
    "case:IDofConceptCase", "case:Label", "case:landRegisterID",
    "case:caseProcedure", "case:Includes_subCases", "monitoringResource",
    "org:resource", "dateStop",
]
