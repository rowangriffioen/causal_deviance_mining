...
# Load configuration
with open(os.path.join(PACKAGE_ROOT, "config_feature_extraction.yaml"), "r", encoding="utf-8") as f:
...
# Configure IMPresseD CLI arguments (invoked in-process)
sys.argv = [
    "IMPresseD_No_GUI.py",
    ...
    "--numerical_attributes",
        "amount", "org:resource", "totalPaymentAmount",
        "article", "points", "expense", "paymentAmount", "matricola",
    "--categorical_attributes",
        "dismissal", "vehicleClass", "lifecycle:transition", "notificationType", "lastSent",
]
